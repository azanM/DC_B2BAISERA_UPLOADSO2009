...
{
    public partial class CUSTOM_S02009_TEMP_IS
    {
        ...
        {
            if (previousValue != null && previousValue.CUSTOM_S02009_TEMP_IS.Contains(this))
            {
                previousValue.CUSTOM_S02009_TEMP_IS.Remove(this);
            }
    
            if (CUSTOM_TRANSACTIONDATA != null)
            {
                if (!CUSTOM_TRANSACTIONDATA.CUSTOM_S02009_TEMP_IS.Contains(this))
                {
                    CUSTOM_TRANSACTIONDATA.CUSTOM_S02009_TEMP_IS.Add(this);
                }
