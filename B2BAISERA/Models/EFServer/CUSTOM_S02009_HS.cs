...
{
    public partial class CUSTOM_S02009_HS
    {
        ...
        {
            if (previousValue != null && previousValue.CUSTOM_S02009_HS.Contains(this))
            {
                previousValue.CUSTOM_S02009_HS.Remove(this);
            }
    
            if (CUSTOM_TRANSACTIONDATA != null)
            {
                if (!CUSTOM_TRANSACTIONDATA.CUSTOM_S02009_HS.Contains(this))
                {
                    CUSTOM_TRANSACTIONDATA.CUSTOM_S02009_HS.Add(this);
                }
